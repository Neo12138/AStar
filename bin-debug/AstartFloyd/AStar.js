...
var AStar2 = (function () {
    ...
    /**在网格中是否找到路径*/
    AStar2.prototype.findPath = function (grid) {
        this._grid = grid;
        this._open = [];
        this._closed = [];
    ...
    /**寻路*/
    AStar2.prototype.search = function () {
        ////九宫格中心节点
        var node;
        while (!this.isEnd) {
            // 当前节点在开放列表中的索引位置
    ...
    /**弗洛伊德路径平滑处理*/
    AStar2.prototype.floyd = function () {
        if (this.path == null)
            return;
    ...
    ////判断3点是否在一直线上
    AStar2.prototype.floydVector = function (target, n1, n2) {
        target.x = n1.x - n2.x;
        target.y = n1.y - n2.y;
    };
    AStar2.prototype.buildPath = function () {
    ...
    Object.defineProperty(AStar2.prototype, "path", {
        get: function () {
            return this._path;
        },
        enumerable: true,
    ...
    Object.defineProperty(AStar2.prototype, "floydPath", {
        get: function () {
    ...
    AStar2.prototype.manhattan = function (node) {
        return Math.abs(node.x - this._endNode.x) * this._straightCost + Math.abs(node.y + this._endNode.y) * this._straightCost;
    };
    AStar2.prototype.euclidian = function (node) {
        var dx = node.x - this._endNode.x;
        var dy = node.y - this._endNode.y;
        return Math.sqrt(dx * dx + dy * dy) * this._straightCost;
    };
    AStar2.prototype.diagonal = function (node) {
    ...
    Object.defineProperty(AStar2.prototype, "visited", {
        get: function () {
...
__reflect(AStar2.prototype, "AStar2");
